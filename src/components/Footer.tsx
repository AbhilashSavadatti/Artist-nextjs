    ...
    <footer className="bg-gray-50">
        <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="flex justify-center text-indigo-800 sm:justify-start">
                Add svg here
              </div>
              ...
              <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                <li>
                  <a href="#" rel="noreferrer" target="_blank" className="text-indigo-800 transition hover:text-indigo-600">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
              <div className="text-center sm:text-left">
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  ...
                  <li>
                    <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> Ask an Expert </a>
                  </li>
                </ul>
              </div>
              <div className="text-center sm:text-left">
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  ...
                  <li>
                    <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> Singers </a>
                  </li>
                  <li>
                    <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> Anchor / Standup Comedy </a>
                  </li>
                  <li>
                    <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> International Artists </a>
                  </li>
                </ul>
              </div>
              <div className="text-center sm:text-left">
          ...
          <div className="mt-12 border-t border-gray-100 pt-6">
            <div className="text-center sm:flex sm:justify-between sm:text-left">
              ...
              <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">© 2024 event duniya</p>
            </div>
          </div>
        </div>
      </footer>
